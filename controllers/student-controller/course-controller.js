...
const getAllStudentViewCourses = async (req, res) => {
  try {
    console.log("handling request in student-controller/course-controller getAllStudentViewCourses controller",req?.ip)
...
const getStudentViewCourseDetails = async (req, res) => {
  try {
    ...
    console.log(
      "handling request in student-controller/course-controller getStudentViewCourseDetails controller",
      req?.ip
    );
    ...
    const courseDetails = await prisma.course.findUnique({
      where: { id: Number(id) },include:{students:true,curriculum:true}
    });
...
const checkCoursePurchaseInfo = async (req, res) => {
  try {
    console.log(
      "handling request in course controller's checkoutCoursePurchseInfo method",
      req?.ip
    );
